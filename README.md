...
## Описание домашнего задания:
   + Основная часть:
     ...
     + организовать монтирование и работу с NFS на клиенте с использованием **NFSv3**
     + создать bash-скрипты для автоматизации развёртывания сервера и клиента NFS
...
16. Создаём bash-скрипты.
    ...
    <ins>**Для клиента**</ins>
      ...
      Выполняем предварительную настройку(для работы со скриптом) на сервере и клиенте NFS.   
...
17. Разворачиваем повторно ВМ и с помощью скриптов конфигурируем их.   
    Выполняем проверку работоспособности по п.14-15. и убеждаемся, что скрипты правильно сконфигурировали NFS.
