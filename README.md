...
17. Смотрим настройки пула и параметры файловой системы.   
    ...
    #### С помощью команд *zpool get all* и *zfs get all* можно посмотреть сразу все параметры, но нас интересуют только размер хранилища, тип pool, размер блока в файловой ситеме, коээфициент сжатия и контрольную сумму.
